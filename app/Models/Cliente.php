...
class Cliente extends Model {
    ...
    public function consultaDados($codigo_cliente, $data1, $data2) {
        ...
        //$data1 = Carbon::createFromFormat('y/m/d', $data1)->format('d-m-y');

        // $result = DB::table('CAO_FATURA')
        // ->orderBy(['CAO_CLIENTE.NO_FANTASIA', 'CAO_FATURA.DATA_EMISSAO'])
        // ->leftjoin('CAO_OS', 'CAO_FATURA.CO_OS', '=', 'CAO_OS.CO_OS')
        // ->leftjoin('CAO_CLIENTE','CAO_FATURA.CO_CLIENTE', '=', 'CAO_CLIENTE.CO_CLIENTE')
        // ->whereIn('CAO_CLIENTE.CO_CLIENTE', $codigo_cliente)
        // ->whereBetween('CAO_FATURA.DATA_EMISSAO', [$data1, $data2])
        // ->groupBy(['CAO_CLIENTE.NO_FANTASIA', 'CAO_FATURA.DATA_EMISSAO', 'CAO_FATURA.VALOR', 'CAO_FATURA.TOTAL_IMP_INC'])
